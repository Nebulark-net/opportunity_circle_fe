    ...
    <section className="max-w-7xl mx-auto px-6 pt-12 pb-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-8">
          ...
          <h1 className="text-5xl xl:text-6xl font-black leading-[1.1] tracking-tight text-zinc-900 dark:text-white">
            Unlock Your Future with <span className="text-primary">Early-Career</span> Opportunities
          </h1>
          <p className="text-lg text-zinc-600 dark:text-accent-muted leading-relaxed max-w-xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button 
              ...
              className="px-8 py-4 bg-zinc-200 dark:bg-zinc-900 font-bold rounded-xl hover:bg-zinc-300 dark:hover:bg-zinc-900/80 transition-all"
            >
        ...
        <div className="relative">
          <div 
            className="aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white dark:border-zinc-900 bg-zinc-200 dark:bg-zinc-900 group"
            style={{
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t frombg-zinc-950/60 to-transparent"></div>
          </div>
          <div className="absolute -bottom-6 -left-6 p-4 rounded-xl bg-white dark:bg-zinc-900 shadow-xl border border-zinc-100 dark:border-zinc-800 flex items-center gap-4 max-w-[200px]">
            <div className="h-10 w-10 rounded-full bg-green-500/20 text-green-500 flex items-center justify-center">
              <span className="material-symbols-outlined">verified</span>
            </div>
            <div className="flex flex-col">
              <span className="text-xs font-bold text-zinc-900 dark:text-white">500+ Programs</span>
              <span className="text-[10px] text-zinc-500 dark:text-zinc-400">Verified Daily</span>
            </div>
          </div>
        </div>
      </div>
